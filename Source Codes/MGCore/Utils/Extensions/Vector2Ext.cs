...
namespace MGCore
{
	public static class Vector2Ext
	{
		...
		public static float DefaultZ = 0f;
		/*FArseer vector2d
	

		public static Microsoft.Xna.Framework.Vector2 ToVector2(this Vector2 input)
		{
			return new Microsoft.Xna.Framework.Vector2(input.X, input.Y);
		}
		*/
		public static Microsoft.Xna.Framework.Vector2 ToVector2(this Farseer.Xna.Framework.Vector2 input)
		{
			return new Microsoft.Xna.Framework.Vector2(input.X, input.Y);
		}
		
		public static Farseer.Xna.Framework.Vector2 ToVector2(this Microsoft.Xna.Framework.Vector2 input)
		{
			return new Farseer.Xna.Framework.Vector2(input.X, input.Y);
		}

		public static Microsoft.Xna.Framework.Vector3 ToVector3(this Farseer.Xna.Framework.Vector2 input)
		{
			return new Microsoft.Xna.Framework.Vector3(input.X, input.Y, DefaultZ);
		}


		public static Microsoft.Xna.Framework.Vector3 ToVector3(this Farseer.Xna.Framework.Vector2 input, float z)
		{
			return new Microsoft.Xna.Framework.Vector3(input.X, input.Y, z);
		}



		public static bool IsValid(this Microsoft.Xna.Framework.Vector2 x)
		{
		...
		/// Creates a new <see cref="Vector2"/> that contains a transformation of 2d-vector by the specified <see cref="Matrix"/>.
		/// </summary>
		/// <param name="position">Source, not Modified <see cref="Vector2"/>.</param>
		/// <param name="matrix">The transformation <see cref="Matrix"/>.</param>
