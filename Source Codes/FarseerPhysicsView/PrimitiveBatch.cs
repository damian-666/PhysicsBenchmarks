...
namespace FarseerPhysicsView
{
    public class PrimitiveBatch : IPrimitiveBatch, IDisposable
    {
                            ...
                            BlendState blendState = null, SamplerState samplerState = null, DepthStencilState depthStencilState = null, RasterizerState rasterizerState = null, float alpha = 1.0f)
        {
            if (_hasBegun)
            {
                Debug.WriteLine("begin called twice, must have been exception or aborted draw, resetting");
                //throw new InvalidOperationException("End must be called before Begin can be called again.");
            }
              
            _blendState = blendState ?? BlendState.AlphaBlend;
            _samplerState = samplerState ?? SamplerState.LinearClamp;
            _depthStencilState = depthStencilState ?? DepthStencilState.None;//if set to Default, fill will not cover edges on prior draws
        ...
        public void End()
        {
            ...
            catch(Exception ex)
            {
                ...
                Debug.WriteLine("error flush lines or trianglles resetting" + ex.Message);
        ...
        private void FlushTriangles()
        {
            ...
            {
                Debug.WriteLine("ex flushing triangles" + ex.Message);
                throw ex;
            }


            finally { _triangleVertsCount = 0; }
         }
        ...
        private void FlushLines()
        {
            ...
            {
                Debug.WriteLine("ex flushing lines" + ex.Message);
                throw ex;
            }


            finally { _lineVertsCount = 0; }
        }
    }
}