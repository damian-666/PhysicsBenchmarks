...
namespace FarseerPhysics.Collision
{
    ...
    public static class TimeOfImpact
    {
        ...
        public static void CalculateTimeOfImpact(out TOIOutput output, ref TOIInput input)
        {
            ...
            //parallel , multithreading note.. shadowplay not... any loop over verts might be parallelize.. pools are done by .net  but
            //but , the other loop, if in parallet, for TOI, would be enougn
