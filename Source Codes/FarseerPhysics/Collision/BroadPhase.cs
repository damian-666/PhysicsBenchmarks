...
namespace FarseerPhysics.Collision
{
    ...
    public class BroadPhase
    {
        ...
        public void UpdatePairs(BroadphaseDelegate callback)
        {
            ...
            for (int j = 0; j < _moveCount; ++j)  //TODO PARALLEL.. seems possible ..   not sure...its writing data..
            {
            ...
            Array.Sort(_pairBuffer, 0, _pairCount);   //TODO is there PARALLEL SORT?      doubt it..
