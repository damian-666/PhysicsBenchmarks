...
[DataContract(Name = "Shape", Namespace = "http://ShadowPlay", IsReference = true)]  
...
[KnownType(typeof(CircleShape))]      
    public abstract class Shape
    {
        ...
        [DataMember]  //shadowplay Mods remove internal on set so it can save/ load in silverlight 
      ...
      //TODO_PORT_SA: Should we mark this as Datamember? Investigate  
