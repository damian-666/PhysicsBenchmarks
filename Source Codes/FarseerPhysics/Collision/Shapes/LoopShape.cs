...
namespace FarseerPhysics.Collision.Shapes
{
    ...
    public class LoopShape : Shape
    {
        ...
        {
            #region ShadowPlay Mod  // use AABB for hit test

            AABB aabb;

            // AABB didn't work, failed on broadphase,  SimWorld.HitTestRectangle(), World.QueryAABB() .
            // sometimes clickable on small top left area of shape.
            ComputeAABB(out aabb, ref transform, 0);
            
            return aabb.Contains(ref point);

            #endregion

            //return false;     // by default edge chain always return false.
        }
