...
namespace FarseerPhysics.Common.PhysicsLogic
{
    ...
    public sealed class Explosion : PhysicsLogic
    {
        ...
        /// </summary>
        public float MaxAngle = Farseer.Xna.Framework.MathHelper.Pi/15;
        ...
        public Dictionary<Fixture, List<Vector2>> Activate(Vector2 pos, float radius, float maxForce)
        {
            ...
            //shadowplay method for wind with blockingis in winddrag, parallel
            //TODO modify for Wind cast..  
            // start wind point  source far away.. then  filter AABB below to rectangle narrow area.   that will elimate all bodies not in wind path..
            // use muliple wind emitters for big wind...  its a ray trace like function..
            ...
            for (int i = 0; i < valIndex; ++i)
            {
                ...
                if (i == valIndex - 1)       //I think for circular explosion..
                {
