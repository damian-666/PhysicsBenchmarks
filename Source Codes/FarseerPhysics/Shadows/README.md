...
The time complexity of this implementation is O(N log N) (where N is the t-otal number of line segments). This is the optimal time complexity for this problem.
