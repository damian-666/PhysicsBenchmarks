...
#region  ShadowPlayMod
        ...
        public void InitializeVelocityConstraints()
        {
            for (int i = 0; i < _constraintCount; ++i)
            {
                ...
                for (int j = 0; j < cc.PointCount; ++j)
                {
                    ...
                    //shadowplay mods.. for big planets this goes off but collision with smaller works as expected
                    //removing assert
        ...
        public void SolveVelocityConstraints()
        {
            ...
            //TODO consider PARALLEL sort these and do parallel for.. see imagesharp use.

            //ask ian for prior use.

            //this affects ccd..
            //TODO try parallel. foreach on update 
