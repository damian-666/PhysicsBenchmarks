...
namespace FarseerPhysics.Dynamics
{
    public class ContactManager
    {
        ...
        private void AddPair(ref FixtureProxy proxyA, ref FixtureProxy proxyB)
        {
            ...
            // Contact creation may swap fixtures.   //shadowplay note THREADING, IS THAT THREAD SAFE?
            fixtureA = c.FixtureA;
            fixtureB = c.FixtureB;
        ...
        internal void Collide()
        {
            ...
            //shadowplay note MULTITHREADING... THREADING   OPTIMIZATON.. BREAK THE LIST INTO PARTS.
            //NUM OF PARTS MIGHT BE GREATER THAN # PARTICLES BECAUSE SOME ARE DONE EARLY THOSE THREADS CAN GET 
            //COME PROCESSOR TIME THEN..   SAYNE n THREADS = PHYSICAL * 2... OR *3 FOR HYPERTHREAD...
            //TESTED WITH WIND,, AND YES.. MORE THREADS THATN PROCESSORS HELPED.. BUT I HAD HYPERTHREAD. 
            //NEED TO REPEAT THE TEST...THREAD TST WAS PROFOUND FOR WIND WHICH DID A LOT OF RAY RASTS.
            //  NX FOR N PROCESSORS., BASICALLY.   except in some older OsX Lion...
            ...
            while (c != null)
            {
                ...
                bool overlap = BroadPhase.TestOverlap(proxyIdA, proxyIdB);//THREADING, THIS SHOULD BE THREAD SAFE.. RAY CASTS ARE.
