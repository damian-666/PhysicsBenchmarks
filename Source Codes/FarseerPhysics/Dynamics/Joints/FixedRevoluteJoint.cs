...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    /// </summary>
    [DataContract(Name = "FixedRevoluteJoint", Namespace = "http://ShadowPlay", IsReference = true)]
    public class FixedRevoluteJoint : Joint
    {
     ...
     //   [DataMember]   apparently doesn't seem to work on overrides .. wont save...otherwise i'd clean the Datamember from the base class
        ...
        // this is unused now, use WorldAnchorB instead.
        //[DataMember(Order = 1)]
        ...
        internal override bool SolvePositionConstraints()
        {
            ...
            // Solve point-to-point constraint.
            {
                ...
                if (C.LengthSquared() > k_allowedStretch * k_allowedStretch)
                {
                    ...
                    //Shadowplay Mod, for massive planets this happens but isnt a problem, test pin joint and spinning planet
