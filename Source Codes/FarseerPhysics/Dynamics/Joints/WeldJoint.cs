...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    /// </summary>
    [DataContract]
    //[DataContract(Name = "WeldJoint", Namespace = "http://ShadowPlay",  IsReference = true)] //TODOWELDJOINT code review .. since  weld exists in sprit and level, should it be a reference?
    public class WeldJoint : Joint
    {
        ...
        public override Vector2 WorldAnchorB
        {
            ...
            set { } 
            // Commented so it can be deserialized successfully
        ...
        internal override void InitVelocityConstraints(ref TimeStep step)
        {
            ...
            NotifyPropertyChanged("ReferenceAngle");  //this InitVelocityConstraints gets called once per update cycle.. send a notification for the prop page..
