...
namespace FarseerPhysics.Controllers
{
    public sealed class BuoyancyController : Controller
    {
        ...
        public AABB Container
        {
            ...
            {
                _container = value;
                _offset = _container.UpperBound.Y;   //shadow play note .. this should be lower bound.. Y+ is down
                //http://farseerphysics.codeplex.com/discussions/254237
            }
        }
        ...
        public override void Update(float dt)
        {
            ...
            World.QueryAABB(fixture =>
                                {
                                    if (fixture.Body.IsStatic || !fixture.Body.Awake)  // note body can fall asleep after sinking.. no need to wake it.
                                        return true;

                                    //after import spirit, this BodyID is not guaranteed to be unique.. better use Hashcode,
                                    //this whole method is not tested.
                               //     if (!_uniqueBodies.ContainsKey(fixture.Body.BodyId))
                                //        _uniqueBodies.Add(fixture.Body.BodyId, fixture.Body);

                      
                                    if (!_uniqueBodies.ContainsKey(fixture.Body.GetHashCode()))
                                        _uniqueBodies.Add(fixture.Body.GetHashCode(), fixture.Body);      
