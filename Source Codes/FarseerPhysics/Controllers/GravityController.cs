...
namespace FarseerPhysics.Controllers
{
    ...
    {
        Linear,   //NOTE  in a "real" 2d Universe, gravity is likely to be inverse linear because flux is a line segment, law of triangles, wave dispersing,  There is no escape velocity, orbits tend to be more likely to be stable from my tests.   Same with sound wave loudness decay with dist..
        DistanceSquared  //flux on an energy receiver is a square.    Gravity could be a dent in space time, and its shape is unobserved and the theoretical cause of gravity is uncertain  regardless, we use what looks "real" and is most fun and convenient, since its an immersive game over accurate simulation
    }
